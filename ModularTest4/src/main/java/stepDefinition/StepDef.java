...
public class StepDef {
	static ConferenceReg conferenceReg = null; // ConferenceReg class object 
	static PaymentDetails paymentDetails = null;  // PaymentDetails class object
	...
	public void user_is_registering() throws Throwable {
		...
		Modules.runTest();
		conferenceReg= new ConferenceReg(Modules.driver);
	...
	public void user_selects_conference_access() throws Throwable {
		conferenceReg.clickNext();
		conferenceReg.giveCconferenceAccess();
	}
